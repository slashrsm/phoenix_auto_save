defmodule PhoenixAutoSaveWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PhoenixAutoSaveWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/phoenix_auto_save_web/templates",
        namespace: PhoenixAutoSaveWeb
